    ...
    <div id="navigation">
        ...
        <ul class="navigation-menu">
            ...
            <li class="has-submenu">
                <a href="{{ route('login') }}">
                    <i class="la la-dashboard"></i>Trang chủ <div class=""></div></a>

            </li>

            <li class="has-submenu">
                <a href="{{ route('linhvuc.danhsach') }}">
                    <i class="la la-cube"></i>Lĩnh vực<div class=""></div></a>
            </li>

            <li class="has-submenu">
                <a href="{{route('cauhoi.danhsach')}}"> <i class="la la-clone"></i>Câu hỏi </a>
